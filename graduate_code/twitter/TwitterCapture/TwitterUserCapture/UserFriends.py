...
@set_logging()
def userFriends(userHost=DEFAULTHOST, userDatabase="twitter", userCollection='user',
                 userFriendsHost=DEFAULTHOST, userFriendsDatabase="twitter", userFriendsCollection='user',
...
if __name__ == "__main__":
    userFriends(proxyList=['192.168.1.148:8118'])
