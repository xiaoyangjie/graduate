...
@set_logging()
def userFollowers(userHost=DEFAULTHOST, userDatabase="twitter", userCollection='user',
                  userFollowersHost=DEFAULTHOST, userFollowersDatabase="twitter", userFollowersCollection='user',
