...
@set_logging()
def userFriends(userHost=MONGOHOST, userDatabase="twitter", userCollection='user',
                 userFriendsHost=MONGOHOST, userFriendsDatabase="twitter", userFriendsCollection='user',
