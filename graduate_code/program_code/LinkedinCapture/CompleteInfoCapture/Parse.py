...
class Parse():
    ...
    def pageParse(self, driver):
        ...
        # 爬取背景总概
        try:
            self.usr['background_summary'] = driver.find_element_by_class_name("pv-top-card-section__summary-text").text
        except NoSuchElementException:
        ...
        try:
            ...
            for item in exp_overview:
                ...
                try:
                    ...
                    pass
                try:
                    temp['company'] = item.find_element_by_class_name("pv-entity__secondary-title").text
                except:
                    pass
                try:
                ...
                try:
                    ...
                    pass
                try:
                    temp['duration'] = item.find_element_by_class_name("pv-entity__bullet-item").text
                except:
                    pass
                try:
        ...
        try:
            for item in driver.find_elements_by_class_name("pv-browsemap-section__member-container"):
                ...
                if url['person_website'].split('/')[0] == 'https:':
                    # time.sleep(10 * 60 * 60)
                    url['person_website'] = url['person_website'].replace('https','http')
